...
const adicionaTarefa = (estado: EstadoAplicacao, tarefa: Tarefa) : EstadoAplicacao =>{
    return {
        ...estado,
...
const editarTarefa = (estado: EstadoAplicacao, tarefa: Tarefa) : EstadoAplicacao => {
    ...
    return { ...estado, tarefas: novasTarefas, tarefaSelecionada: null };
}

const removerTarefaSelecionada = (estado: EstadoAplicacao, tarefa: Tarefa): EstadoAplicacao =>{
    const novaLista: Tarefa[] = estadoInicial.tarefas.filter((task)=>{
...
const atualizarUI = ()=>{
    ...
    const activeTaskDescription = document.querySelector<HTMLDivElement>('.app__section-active-task-description')
    ...
    const btnCancelarAddEditarTarefa = document.querySelector<HTMLButtonElement>('.app__form-footer__button--cancel')
    const btnDeletarTarefa = document.querySelector<HTMLButtonElement>('.app__form-footer__button--delete')
    const tituloFormularioAdicionarTarefa = document.querySelector<HTMLLabelElement>('.app__form-label')
    ...
    btnRemoverConcluidas.onclick = () => {
        const novoEstado: Tarefa[] = estadoInicial.tarefas.filter((tarefa)=>{
            return !tarefa.concluida
        })

        estadoInicial = { ...estadoInicial, tarefas: novoEstado}
        atualizarUI()
    }

    btnRemoverTodas.onclick = () => {   
        estadoInicial = { ...estadoInicial, tarefas: []}
        atualizarUI()
    }
